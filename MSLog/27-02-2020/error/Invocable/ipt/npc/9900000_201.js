A:\游戏服务端/Script/npc/9900000_201.js
javax.script.ScriptException: <eval>:52:3 Illegal break statement
			break;
			^ in <eval> at line number 52 at column number 3
	...
	at scripting.npc.NPCConversationManager.openNpc(NPCConversationManager.java:280)
	at jdk.nashorn.internal.scripts.Script$Recompilation$1386847$1229AAA$\^eval\_.action(<eval>:272)
...
Caused by: jdk.nashorn.internal.runtime.ParserException: <eval>:52:3 Illegal break statement
			break;
			^
	at jdk.nashorn.internal.parser.AbstractParser.error(AbstractParser.java:269)
	at jdk.nashorn.internal.parser.AbstractParser.error(AbstractParser.java:253)
	at jdk.nashorn.internal.parser.Parser.breakStatement(Parser.java:1525)
	at jdk.nashorn.internal.parser.Parser.statement(Parser.java:905)
...
---------------------------------
A:\游戏服务端/Script/npc/9900000_201.js
javax.script.ScriptException: <eval>:34:3 Illegal break statement
			break;
			^ in <eval> at line number 34 at column number 3
	at jdk.nashorn.api.scripting.NashornScriptEngine.throwAsScriptException(NashornScriptEngine.java:470)
	at jdk.nashorn.api.scripting.NashornScriptEngine.compileImpl(NashornScriptEngine.java:537)
	at jdk.nashorn.api.scripting.NashornScriptEngine.compileImpl(NashornScriptEngine.java:524)
	at jdk.nashorn.api.scripting.NashornScriptEngine.evalImpl(NashornScriptEngine.java:402)
	...
	at scripting.npc.NPCScriptManager.start(NPCScriptManager.java:38)
	at scripting.npc.NPCConversationManager.openNpc(NPCConversationManager.java:280)
	at jdk.nashorn.internal.scripts.Script$Recompilation$1387532$1229AAA$\^eval\_.action(<eval>:272)
	at scripting.npc.NPCScript$$NashornJavaAdapter.action(Unknown Source)
	at scripting.npc.NPCScriptManager.action(NPCScriptManager.java:158)
	at handling.channel.handler.NPCHandler.NPCMoreTalk(NPCHandler.java:126)
	at packet.netty.ChannelHandler.channelRead(ChannelHandler.java:170)
	...
	at io.netty.util.concurrent.FastThreadLocalRunnable.run(FastThreadLocalRunnable.java:30)
	at java.lang.Thread.run(Unknown Source)
Caused by: jdk.nashorn.internal.runtime.ParserException: <eval>:34:3 Illegal break statement
			break;
			^
	at jdk.nashorn.internal.parser.AbstractParser.error(AbstractParser.java:269)
	at jdk.nashorn.internal.parser.AbstractParser.error(AbstractParser.java:253)
...
javax.script.ScriptException: <eval>:34:3 Illegal break statement
	...
	at scripting.npc.NPCScriptManager.start(NPCScriptManager.java:38)
	at scripting.npc.NPCConversationManager.openNpc(NPCConversationManager.java:280)
	at jdk.nashorn.internal.scripts.Script$Recompilation$1388685$1229AAA$\^eval\_.action(<eval>:272)
	at scripting.npc.NPCScript$$NashornJavaAdapter.action(Unknown Source)
	at scripting.npc.NPCScriptManager.action(NPCScriptManager.java:158)
	at handling.channel.handler.NPCHandler.NPCMoreTalk(NPCHandler.java:126)
	at packet.netty.ChannelHandler.channelRead(ChannelHandler.java:170)
...
javax.script.ScriptException: <eval>:34:3 Illegal break statement
	...
	at scripting.npc.NPCScriptManager.start(NPCScriptManager.java:38)
	at scripting.npc.NPCConversationManager.openNpc(NPCConversationManager.java:280)
	at jdk.nashorn.internal.scripts.Script$Recompilation$1388830$1229AAA$\^eval\_.action(<eval>:272)
	at scripting.npc.NPCScript$$NashornJavaAdapter.action(Unknown Source)
	at scripting.npc.NPCScriptManager.action(NPCScriptManager.java:158)
	at handling.channel.handler.NPCHandler.NPCMoreTalk(NPCHandler.java:126)
	at packet.netty.ChannelHandler.channelRead(ChannelHandler.java:170)
