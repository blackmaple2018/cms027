...
var 数据 = [
	...
	//树灵之剑lv.50   制作卷 * 5  青铜 * 7 钢铁 * 7
	[1302010,0,20,10*10000,制作卷,5,4011000,7,4011001,7],
	//奇形刀lv.60  树灵之剑 * 1 制作卷 * 7  青铜 * 4 钢铁 * 4  锂矿石 * 8
	[1302011,400,50,10*10000,制作卷,6,1302010,1,4011000,4,4011001,4,4011002,8],
	//火焰刀lv.70 
	[1302012,800,70,10*10000,制作卷,7,1302011,1,4021000,5,4021002,5],
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		var 文本 = "#i4030000#  #i4030001#  #i4030010# #r#e< 单手剑类制造 >#k#n #i4030011#  #i4030014#  #i4030015#\r\n\r\n";
