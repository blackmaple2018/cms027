...
var 数据 = [
	...
	//光明斧lv.60   制作卷 * 5  青铜 * 3 钢铁 * 3
	[1412007,0,20,10*10000,制作卷,6,4011000,3,4011001,3],
	//雷电斧lv.70  光明斧 * 1 制作卷 * 6  青铜 * 4 钢铁 * 4  锂矿石 * 4
	[1412008,400,50,10*10000,制作卷,7,1412007,1,4011000,4,4011001,4,4011002,4],
	//大力神之斧lv.80   雷电斧 * 1 制作卷 * 6  青铜 * 4 钢铁 * 4  锂矿石 * 4
	[1412009,800,70,10*10000,制作卷,8,1412008,1,4011000,4,4011001,4,4011002,4],
	//项羽之斧lv.80   
	[1412010,1200,70,10*10000,制作卷,9,1412009,1,4021000,5,4021002,5],
	
	
	
	//橡皮榔头
	//[1302021,3000,70,100*10000,制作卷,50,4021006,5,4011006,5]
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		var 文本 = "#i4030000#  #i4030001#  #i4030010# #r#e< 双手斧类制造 >#k#n #i4030011#  #i4030014#  #i4030015#\r\n\r\n";
