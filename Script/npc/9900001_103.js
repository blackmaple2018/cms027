...
var 数据 = [
	...
	//猛禽斧lv.60   制作卷 * 5  青铜 * 3 钢铁 * 3
	[1312009,0,20,10*10000,制作卷,6,4011000,3,4011001,3],
	//黄金斧lv.70  猛禽斧 * 1 制作卷 * 6  青铜 * 4 钢铁 * 4  锂矿石 * 4
	[1312010,400,50,10*10000,制作卷,7,1312009,1,4011000,4,4011001,4,4011002,4],
	//花灵之斧lv.80   黄金斧 * 1 制作卷 * 6  青铜 * 4 钢铁 * 4  锂矿石 * 4
	[1312011,800,70,10*10000,制作卷,8,1312010,1,4011000,4,4011001,4,4011002,4],
	//战魂之斧lv.90   
	[1312015,1200,70,10*10000,制作卷,9,1312011,1,4021000,5,4021002,5],
	
	
	
	//阎王笔
	[1312014,3000,70,10*10000,制作卷,20,4011000,3,4011001,3]
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		var 文本 = "#i4030000#  #i4030001#  #i4030010# #r#e< 单手斧类制造 >#k#n #i4030011#  #i4030014#  #i4030015#\r\n\r\n";
