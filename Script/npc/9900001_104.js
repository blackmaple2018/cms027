...
var 数据 = [
	...
	//双天戟lv.50   制作卷 * 5  青铜 * 3 钢铁 * 3
	[1432005,0,20,10*10000,制作卷,6,4011000,3,4011001,3],
	//十字枪lv.60  双天戟 * 1 制作卷 * 6  青铜 * 4 钢铁 * 4  锂矿石 * 4
	[1432006,400,50,10*10000,制作卷,7,1432005,1,4011000,4,4011001,4,4011002,4],
	//银龙枪lv.70   十字枪 * 1 制作卷 * 6  青铜 * 4 钢铁 * 4  锂矿石 * 4
	[1432007,800,70,10*10000,制作卷,8,1432006,1,4011000,4,4011001,4,4011002,4],
	//奥丁手戟lv.80   
	[1432010,1200,70,10*10000,制作卷,9,1432007,1,4021000,5,4021002,5],
	
	
	
	//海神叉
	[1432008,3000,70,10*10000,制作卷,20,4011000,3,4011001,3],
	//木精灵枪
	[1432009,3000,70,10*10000,制作卷,35,4011000,3,4011001,3]
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		var 文本 = " #i4030000#  #i4030001#  #i4030010# #r#e< 长枪类制造 >#k#n #i4030011#  #i4030014#  #i4030015#\r\n\r\n";
