...
var 数据 = [
	...
	//月神刀lv.60   制作卷 * 5  青铜 * 3 钢铁 * 3
	[1442019,0,20,10*10000,制作卷,6,4011000,3,4011001,3],
	//黄龙刀lv.70  双天戟 * 1 制作卷 * 6  青铜 * 4 钢铁 * 4  锂矿石 * 4
	[1442008,400,50,10*10000,制作卷,7,1442019,1,4011000,4,4011001,4,4011002,4],
	//月灵戟lv.80   十字枪 * 1 制作卷 * 6  青铜 * 4 钢铁 * 4  锂矿石 * 4
	[1442002,800,70,10*10000,制作卷,8,1442008,1,4011000,8,4011001,8,4011002,8],
	//巨灵开山斧lv.90   
	[1442020,1200,70,10*10000,制作卷,9,1442002,1,4021000,5,4021002,5],
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		var 文本 = " #i4030000#  #i4030001#  #i4030010# #r#e< 长矛类制造 >#k#n #i4030011#  #i4030014#  #i4030015#\r\n\r\n";
