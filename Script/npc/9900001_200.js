...
var 数据 = [
	...
	//白龙之杖lv.55   制作卷 * 5  青铜 * 3 钢铁 * 3
	[1382006,0,20,10*10000,制作卷,6,4011000,3,4011001,3],
	//魔灵之翼lv.7065双天戟 * 1 制作卷 * 6  青铜 * 4 钢铁 * 4  锂矿石 * 4
	[1382007,400,50,10*10000,制作卷,7,1382006,1,4011000,4,4011001,4,4011002,4],
	//死灵法杖.75   十字枪 * 1 制作卷 * 6  青铜 * 4 钢铁 * 4  锂矿石 * 4
	[1382010,800,70,10*10000,制作卷,8,1382007,1,4011000,8,4011001,8,4011002,8],
	//魔灵之魂.85
	[1382008,1200,70,10*10000,制作卷,9,1382010,1,4021000,5,4021002,5],
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		var 文本 = " #i4030000#  #i4030001#  #i4030010# #r#e< 长杖类制造 >#k#n #i4030011#  #i4030014#  #i4030015#\r\n\r\n";
