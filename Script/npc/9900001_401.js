...
var 数据 = [
	...
	[1332017,0,20,10*10000,制作卷,6,4011000,3,4011001,3],
	
	

	
	[1332018,800,70,10*10000,制作卷,8,1332017,1,4011000,8,4011001,8,4011002,8],
	
	
	
	
	[1332019,800,70,10*10000,制作卷,8,1332017,1,4011000,7,4011001,7,4011002,7],
	
	
	[1332023,1200,70,10*10000,制作卷,9,1332018,1,4021000,5,4021002,5],
	
	
	
	[1332022,1200,70,10*10000,制作卷,9,1332019,1,4021000,4,4021002,4],

	//乌龙茶
	[1332021,3000,70,100*10000,制作卷,50,4021006,5,4011006,5]
]
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		var 文本 = " #i4030000#  #i4030001#  #i4030010# #r#e< 短剑类制造 >#k#n #i4030011#  #i4030014#  #i4030015#\r\n\r\n";
