...
var 数据 = [
	...
	//飞侠盾牌
	[1092018,1000,20,100*10000,"飞侠",4011000,5,4011001,5,4011002,5,4011003,5,4011004,5],
	
	//光子盾
	[1092021,500,20,50*10000,"魔法师",4021000,5,4021001,5,4021005,5],

	//电磁光盾
	[1092029,1000,20,50*10000,"魔法师",1092021,1,4021000,5,4021001,5,4021004,5,4021005,5],
	
	
	//铜狮鹫盾
	[1092023,500,20,50*10000,"战士",4011003,5,4011001,5,4011005,5],
	
	//银狮鹫盾
	[1092024,500,20,50*10000,"战士",1092023,1,4011003,2,4011001,2,4011005,2,4011006,1],
	
	//金狮鹫盾
	[1092025,500,20,50*10000,"战士",1092024,1,4011003,2,4011001,2,4011005,2,4011006,1],
	
	
	//调色板盾牌
	[1092022,3000,20,250*10000,"全职业",1092018,1,1092029,1,1092008,1]
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		var 文本 = " #i4030000#  #i4030001#  #i4030010# #r#e< 盾牌类制造 >#k#n #i4030011#  #i4030014#  #i4030015#\r\n\r\n";
