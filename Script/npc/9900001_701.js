...
var 数据 = [
	//枫叶帽0
	[1002419,4000,50,100*10000,4001124,50],
	
	//枫叶手套20
	[1082441,4000,50,100*10000,4001124,100],
	
	//枫叶耳环20
	[1032035,4000,50,100*10000,4001124,100],
	
	//枫叶披风70
	[1102071,4000,50,100*10000,4001124,200],
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		var 文本 = "#i4030000#  #i4030001#  #i4030010# #r#e< 枫叶套装制造 >#k#n #i4030011#  #i4030014#  #i4030015#\r\n\r\n\t\t\t套装效果\r\n\t\t\t(2)物品爆率+#r10%#k#k\r\n\t\t\t(3)角色受到的伤害-#r10%#k\r\n\t\t\t(4)角色死亡损失经验-#r50%#k\r\n\t\t\t(4)幸运女神光效\r\n\r\n";                                     
