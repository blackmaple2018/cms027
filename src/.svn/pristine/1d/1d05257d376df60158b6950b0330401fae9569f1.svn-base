...
public class ChannelHeaders {
    ...
    public static class PartyHeaders {
        ...
        public static final byte
            ...
            PARTY_SILENT_LIST_UPDATE = 0x06,
                
            PARTY_CREATED = 0x07,
            PARTY_CREATED_ALREADY_JOINED = 0x08,
            PARTY_IS_BEGINNER = 0x09,
                
            LEFT_PARTY = 0x0B,
            NOT_IN_PARTY = 0x0C,
                
            JOINED_PARTY = 0x0E,
            ALREADY_IN_PARTY = 0x0F,
            PARTY_FULL = 0x10,
                
            PARTY_CANNOT_FIND = 0x13,
            PARTY_BUSY = 0x14,
            PARTY_INVITE_DENIED = 0x15,
    ...
    public static class PlayerInteractionHeaders {
        ...
        public static final byte
            ...
            ACT_BUY = 0x13, 
            ACT_CANNOT_BUY = 0x14, 
            ACT_SHOP_ITEM_UPDATE = 0x15, 
            ACT_SHOP_SOLD_ITEM = 0x16,
            ACT_REMOVE_ITEM = 0x17,
