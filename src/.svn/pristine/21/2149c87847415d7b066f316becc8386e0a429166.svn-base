...
public class MapleLifeFactory {
    ...
    private static final MapleDataProvider dataNPC = MapleDataProviderFactory.getDataProvider("Npc");
    ...
    public static MapleMonsterStats getMonsterStats(int mid) {
        try {
            ...
            if (stats == null) {
                ...
                if (special != null) {
                    stats.setSelfDestruction(new SelfDestruction((byte) MapleDataTool.getInt(special.getChildByPath("action"), 0),
