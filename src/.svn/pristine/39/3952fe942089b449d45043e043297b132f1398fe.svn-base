...
/**
 *
 * @author Rahul A simplified type of TimerManager class composed of divided
 * timers to handle specific tasks. <br>
 * This implementation provides distribution of work and thus improves the
 * stability of the scheduling system as a whole.
 */
public abstract class TimerTools {
    ...
    /**
     * A wrapper class to catch exceptions when the scheduled Runnable
     * executes.<br>
     ...
     * In order to stop currently executing tasks, see:
     * {@link ScheduledThreadPoolExecutor.shutDownNow()}
     */
    public void stop() {
        stpe.shutdown();
    }
     ...
     * @param repeatTime The time in milliseconds to re-execute the run()
     * method. <br>
     ...
     *
     * @param r The Runnable to be scheduled. <br>
     * @param timestamp The timestamp in milliseconds when the Runnable will be
     * executed.<br>
     * example:<br>
     * <strong>
     * long then = System.currentTimeMillis() + object.getTime(); Runnable r =
     * new Runnable() {. . .};<br>
     ...
     * <strong>
     * Note:<br>
     * This method will not work for tasks already started, and is strongly
     * discouraged as a cancellation technique.<br>
     * </strong>
     */
    ...
    /**
     * A MapleTimer implementation to handle Miscellaneous server activities
     * such as warping, etc.
     */
    ...
    /**
     * A MapleTimer implementation to handle monster spawning and all
     * monster-related server activities.
     */
    ...
    /**
     * A MapleTimer implementation to handle all skill (buff, summon,
     * etc)-related server activities.
     */
    ...
    public static class CloneTimer extends TimerTools {
