...
public class Equip extends Item {
    ...
    public void setDzlevel(int dzlevel) {
        this.dzlevel = dzlevel;
    }

    public byte getSocket() {
        if (option == null) {
            option = new EquipOption(this);
            option.rebuildEquipOptions();
            //System.err.println("getSocket - itemID: " + getItemId());
        }
        return getEquipOption().getSocket();
    }
    
    public void setSocket(byte socket) {
        if (option == null) {
            option = new EquipOption(this);
            option.rebuildEquipOptions();
            System.err.println("setSocket - itemID: " + getItemId());
        }
        getEquipOption().setSocket(socket);
    }
    ...
    public void setOption(EquipOption option) {
        if (option == null) {
            option = new EquipOption(this);
            option.rebuildEquipOptions();
            System.err.println("setSocket - itemID: " + getItemId());
    ...
    public EquipOption getEquipOption() {
        if (option == null) {
            option = new EquipOption(this);
            option.rebuildEquipOptions();
            System.err.println("setSocket - itemID: " + getItemId());
