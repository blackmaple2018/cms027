...
public class GameConstants {
    ...
    // NPCs
    public static final long BLOCK_NPC_RACE_CONDT = (long) (1 * 1000); //Time the player client must wait before reopening a conversation with an NPC.
    ...
    /**
     * This is a list of boss monsters that can drop mesos from the range that
     * is inside the blacklistedBosses method
     *
     * @param mobId
     * @return boolean
     */
