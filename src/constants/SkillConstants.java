...
public class SkillConstants {
    ...
    public static class Beginner {
        ...
        public static final int BlessingOfTheFairy = 12,
                EchoOfHero = 1005,
                FollowTheLead = 8,
                MonsterRider = 1004,
                NimbleFeet = 1002,
    ...
    public static class Swordman {
        ...
        public static final int ImprovedMaxHpIncrease = 1000001,
                IronBody = 1000003;
    }

    public static class Fighter {

        public static final int AxeBooster = 1101005,
                AxeMastery = 1100001,
                PowerGuard = 1101007,
                Rage = 1101006,
    ...
    public static class Page {
        ...
        public static final int BwBooster = 1201005,
                BwMastery = 1200001,
                PowerGuard = 1201007,
    ...
    public static class WhiteKnight {
        ...
        public static final int BwFireCharge = 1211004,
                BwIceCharge = 1211006,
                BwLitCharge = 1211008,
                ChargeBlow = 1211002,
                MagicCrash = 1211009,
    ...
    public static class SpearMan {
        ...
        public static final int HyperBody = 1301007,
                IronWill = 1301006,
    ...
    public static class DragonKnight {
        ...
        public static final int DragonBlood = 1311008,
    ...
    public static class Magician {
        ...
        public static final int ImprovedMaxMpIncrease = 2000001,
                MagicArmor = 2001003,
                MagicGuard = 2001002;
    }
    ...
    public static class FPArchMage {
        ...
        public static final int BigBang = 2121001,
                Elquines = 2121005,
                FireDemon = 2121003,
                HerosWill = 2121008,
                Infinity = 2121004,
    ...
    public static class ILWizard {
        ...
        public static final int ColdBeam = 2201004,
                Meditation = 2201001,
                MpEater = 2200000,
                Slow = 2201003;
    }
    ...
    public static class ILMage {
        ...
        public static final int ElementAmplification = 2210001,
    ...
    public static class ILArchMage {
        ...
        public static final int BigBang = 2221001,
                Blizzard = 2221007,
                HerosWill = 2221008,
                IceDemon = 2221003,
                Ifrit = 2221005,
    ...
    public static class Gm {
        ...
        public static final int Hide = 5001004, Resurrection = 5001005, SuperDragonRoar1 = 5001001, SuperDragonRoar2 = 5001006, Teleport1 = 5001002, Teleport2 = 5001007;
    }

    public static class SuperGm {

        public static final int Bless = 5101003, Haste = 9101001, HealnDispel = 9101000, Hide = 5101004, HolySymbol = 9101002, HyperBody = 9101008, Resurrection = 9101005, SuperDragonRoar = 9101006, Teleport = 9101007;
    }
    ...
    public static boolean isFinisherSkill(int skillId) {
        return skillId > Crusader.斗气集中 && skillId < Crusader.防御崩坏 || skillId == 11111002 || skillId == 11111003;
    }
    ...
    public static final boolean isWarrior(int job) {
        switch (job) {
            case 100:
            case 110:
            case 111:
    ...
    public static final boolean isMagician(int job) {
        switch (job) {
            case 200:
            case 210:
            case 211:
    ...
    public static final boolean isArcher(int job) {
        switch (job) {
            case 300:
            case 310:
            case 311:
    ...
    public static final boolean isThief(int job) {
        switch (job) {
            case 400:
            case 410:
            case 411:
