...
public class LoginTools {
    ...
    public static void setUp() {
        ...
        MapleDataProvider dataProvider = MapleDataProviderFactory.getDataProvider("Etc");
        ...
        for (int i = 0; i < 2; i++) {
            for (MapleData data : newEquipData.getChildByPath(i == 1 ? "CharFemale" : "CharMale").getChildren()) {
