...
public class FieldManager {
    ...
    private final Map<Integer, Field> maps = new HashMap<>();
    private final ReentrantReadWriteLock.ReadLock mapsRLock;
    private final ReentrantReadWriteLock.WriteLock mapsWLock;
    private final ReentrantReadWriteLock mapLock;
    private int channel;
    private int world;

    public FieldManager(EventInstanceManager eim, MapleDataProvider source, MapleDataProvider stringSource, int world, int channel) {
        this.source = source;
        ...
        this.mapsRLock = mapLock.readLock();
        this.mapsWLock = mapLock.writeLock();
    }
    ...
    private Field loadMapFromWz(int mapid, Integer omapid, boolean respawns, boolean npcs, boolean reactors) {
        Field map;
        ...
        map = new Field(mapid, world, channel, MapleDataTool.getInt("info/returnMap", mapData), monsterRate);
